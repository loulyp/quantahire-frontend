...
import { X, Brain, FileText, Briefcase, MapPin, GraduationCap, Star, TrendingUp, User } from "lucide-react";
...
export default function CandidateProfileModal({ candidateEmail, candidateName, onClose }) {
  ...
  useEffect(() => {
    Promise.all([
      ...
      quantaClient.entities.AssessmentResult.filter({ candidate_email: candidateEmail }, "-created_date", 1),
